...
```{r}
source(here("Labs/R/dexppop_play.R"))
source(here("Labs/R/dexppop.R"))
source(here("Labs/R/exppop.R"))
```
...
initialrabbits = 2
newparms = c(r=0.03, carry_capacity=300)
years = seq(from = 1, to = 100, by = 2)

#apply solver
results = ode(initialrabbits, 
              years, 
              dexppop_play,
              newparms)
head(results)
