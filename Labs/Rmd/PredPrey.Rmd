...
# create a latin hyper cube - define LHS object
...
p_wrapper = function(rprey,alpha, eff, pmort, K, currpop, days, func) {
    ...
    result = ode(y=currpop, times=days, func=func, parms=parms) # runs ODE
