...
tmp = pops %>% map(~dexppop( time=0,r=0.01, P=.x)) # repeat a particular function
pchange = unlist(tmp)
...
if positive, pop is growing; if neg. pop is declining
...
able to integrate w/o numerical solution

```{r explicit}
source("../Labs/R/exppop.R")
